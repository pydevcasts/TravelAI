<template>
  ...
  >
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      <div
        class="relative z-30 mx-auto -mt-10 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3"
      >

      <div class="relative z-30 mx-auto -mt-10 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
    <div class="relative drop-shadow-2">
        <img :src="userStore.user.avatar || '@/assets/images/cover/cover-06.png'" alt="profile" class="rounded-full h-full w-full object-cover">
      ...
      <div class="mt-4" v-if="userStore.user">
