      ...
      <div v-if="userStore.user" class="mt-4">
        ...
        <div class="mt-6.5">
          ...
          <div class="flex items-center justify-center gap-3.5">
            <a aria-label="social-icon" class="hover:text-primary" href="#" name="social-icon">
              <svg
                  class="fill-current"
                  fill="none"
                  height="22"
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_30_970">
                    <rect fill="white" height="22" transform="translate(0.666138)" width="22"/>
                  </clipPath>
                </defs>
              </svg>
            </a>
              ...
              >
                ...
                <defs>
                  <clipPath id="clip0_30_974">
                    <rect fill="white" height="22" transform="translate(0.333862)" width="22"/>
                  </clipPath>
                </defs>
              </svg>
            </a>
...
const fetchUserDetails = async () => {
  const userId = userStore.user?.id; // Use optional chaining
